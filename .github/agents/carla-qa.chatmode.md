...
**Task**: `adversarial-review.task.md`
...
### [TC] Test Coverage - Analisar Cobertura
**Comando**: `TC`, `test-coverage`
**Task**: `test-coverage.task.md`

**O que faz**:
- Analisa cobertura de testes (unit, integration, e2e)
- Identifica gaps de cobertura
- Sugere testes adicionais necessários
- Verifica métrica de cobertura (target: >80%)

**Quando usar**: Para avaliar qualidade da suite de testes.

---

### [BV] Boundary Value - Análise de Limites
**Comando**: `BV`, `boundary-value`
**Task**: `boundary-value-analysis.task.md`

**O que faz**:
- Análise de valores limites e edge cases
- Identifica boundary conditions críticos
- Sugere casos de teste para limites
- Valida tratamento de erros em boundaries

**Quando usar**: Para garantir robustez em entradas de dados e validações.
...
<menu extends="avanade-master.md#menu">
  ...
  <item cmd="AR or adversarial-review" task="adversarial-review.task.md">[AR] Adversarial Review: Revisão adversarial profunda</item>
  <item cmd="TC or test-coverage" task="test-coverage.task.md">[TC] Test Coverage: Analisar cobertura de testes</item>
  <item cmd="BV or boundary-value" task="boundary-value-analysis.task.md">[BV] Boundary Value: Análise de valores limites</item>
</menu>
...
<dependencies extends="avanade-master.md#dependencies">
  ...
  <tasks>
    ...
    - code-review.task.md
    - test-coverage.task.md
    - boundary-value-analysis.task.md
  </tasks>
  <checklists>
